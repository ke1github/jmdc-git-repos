...
export default function HomePage() {
  return (
    <main className="min-h-screen w-full bg-white text-gray-900">
      ...
      {/* 🌞 Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-orange-100 py-24">
      ...
      <section className="py-16 bg-orange-500 text-white text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <p className="mb-6 text-base md:text-lg">Join thousands of smart users who trust JMDC Energy for their solar solutions.</p>
